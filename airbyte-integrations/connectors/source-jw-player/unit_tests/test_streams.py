...
import pytest
from source_jw_player.source import JwPlayerStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(JwPlayerStream, "path", "v0/example_endpoint")
    mocker.patch.object(JwPlayerStream, "primary_key", "test_primary_key")
    mocker.patch.object(JwPlayerStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = JwPlayerStream()
